...
@jogo_router.post("/{jogo_id}/finalizar")
    ...
    try:
        ...
        for est in dados.estatisticas_jogadores:
            ...
            if atleta:
                ...
                soma_stats = ((atleta.pontos * 0.4) + (atleta.assistencias * 0.3) + (atleta.rebotes * 0.2) + (atleta.roubos * 0.05) + (atleta.bloqueios * 0.05))
                atleta.overall = int(soma_stats / (atleta.jogos * 5)) if atleta.jogos > 0 else 58
